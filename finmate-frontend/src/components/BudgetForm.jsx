...
export default function BudgetForm({ onSaved }) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="border border-hairline rounded-xl p-5 animate-in card-surface" noValidate>
      <p className="font-mono text-sm text-bone/65 uppercase tracking-wide mb-4">Set a budget</p>
      ...
      <div className="mt-3">
        <label className="font-mono text-sm text-bone/75 uppercase tracking-wide">Monthly limit (₹)</label>
        <input
          type="number"
          step="0.01"
          inputMode="decimal"
