  ...
  return (
    <div className="min-h-screen bg-app relative">
      ...
      <main className="relative z-10 p-6 max-w-3xl mx-auto">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="border border-hairline rounded-xl p-5 mt-6 card-surface animate-in" noValidate>
          <p className="font-mono text-sm text-bone/65 uppercase tracking-wide mb-4">Create a group</p>

          <label className="font-mono text-sm text-bone/75 uppercase tracking-wide">Group name</label>
          <input
            type="text"
        ...
        <div className="mt-8">
          <p className="font-mono text-sm text-bone/65 uppercase tracking-wide mb-3">Your groups</p>

          {loading && <p className="font-mono text-bone/65 text-sm flex items-center gap-2"><span className="spinner text-ledger" />loading…</p>}
          ...
          <div className="space-y-3">
            {groups.map((g) => (
              <div
                key={g.id}
                className="flex items-center justify-between border border-hairline rounded-xl p-4 hover:border-signal transition-colors fun-hover card-surface"
              >
